...
from uscbp.registration.views import activate
from uscbp.registration.views import register
from uscbp.bodb.forms import BodbRegistrationForm
...
urlpatterns = patterns('',
                       ...
                       url(r'^register/$',
                           register,
                           {'form_class': BodbRegistrationForm},
