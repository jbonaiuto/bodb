...
from uscbp.registration.forms import RegistrationForm
from uscbp.registration.models import RegistrationProfile
from uscbp.bodb.views import *
    ...
    **Template:**
    ...
    if request.method == 'POST':
        ...
        captcha_response = captcha.submit(request.POST.get("recaptcha_challenge_field", None),
            request.POST.get("recaptcha_response_field", None), settings.RECAPTCHA_PRIVATE_KEY,
