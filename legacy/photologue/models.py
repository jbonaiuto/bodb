...
class Photo(ImageModel):
    ...
    is_public = models.BooleanField(_('is public'), help_text=_('Public photographs will be displayed in the default views.'))
    tags = TagField(help_text=tagfield_help_text, verbose_name=_('tags'))
...
class PhotoSizeCache(object):
    ...
    def __init__(self):
        ...
        if not len(self.sizes):
            sizes = PhotoSize.objects.using('legacy').all()
            for size in sizes:
